...
function MainApp({ session, onLogout }) {
  ...
  return (
  <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-slate-100 p-6 font-fredoka">      
      ...
      /></div>
        ...
        <div className="bg-slate-900/60 backdrop-blur rounded-2xl shadow-xl p-6 border border-slate-800">
          ...
          <div className="mt-6 p-4 rounded-xl border border-slate-800 bg-slate-950">
            ...
            <div className="mt-4 rounded-xl overflow-hidden border border-slate-400">
              <iframe
            ...
            <div className="mt-2 text-sm text-slate-200">{currentPlaylist?.title}</div>
          </div>
